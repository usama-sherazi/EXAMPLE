...
public class SipWrapper implements MethodChannel.MethodCallHandler {
    ...
    public void setup(FlutterPlugin.FlutterPluginBinding flutterPluginBinding) {
        ...
        Log.d("SipWrapper.java","channel setup" );
    ...
    public void saveSIPRegistrationStatus(boolean isRegistered) {
        SharedPreferences prefs = context.getSharedPreferences("SIP_PREFS", Context.MODE_PRIVATE);
    ...
    private void initAbtoPhone() {
        ...
        cfg.setSignallingTransport(AbtoPhoneCfg.SignalingTransportType.TLS);

        AbtoPhoneCfg.setLogLevel(0, true);
        ...
        phone.setRegistrationStateListener(new OnRegistrationListener() {
            ...
            public void onRegistered(long p0) {
                ...
                saveSIPRegistrationStatus(true);
                // Post the method invocation to the main thread
            ...
            public void onUnRegistered(long p0) {
                ...
                saveSIPRegistrationStatus(false);
                // Post the method invocation to the main thread
                mainHandler.post(new Runnable() {
                    @Override
                    public void run() {
    ...
    public void onMethodCall(@NonNull MethodCall call, @NonNull MethodChannel.Result result) {
        ...
        if (call.method.equals("getSIPStatus")) {
            SharedPreferences prefs = context.getSharedPreferences("SIP_PREFS", Context.MODE_PRIVATE);
