                  ...
                  children: <Widget>[
                    ...
                    TextFormField(
                      controller: teLogin = TextEditingController(
                        text: "123" // You can put here your test credentials
                      ),
                    ),
                    SizedBox(height: 15),
                    Text('Password:'),
                    TextFormField(
                      controller: tePass = TextEditingController(
                          text: "xxx123" // You can put here your test credentials
                      ),
                    ),
                    SizedBox(height: 15),
                    Text('Domain:'),
                    TextFormField(
                      controller: teDomain = TextEditingController(
                          text: "koffice.zapto.org" // You can put here your test credentials
                      ),
                    ),
                    SizedBox(height: 15),
